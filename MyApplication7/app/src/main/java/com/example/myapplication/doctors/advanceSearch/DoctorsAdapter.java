...
public class DoctorsAdapter extends RecyclerView.Adapter<DoctorsAdapter.DoctorSViewHolder> {
    ...
    private void populateColumnPositions() {
        ...
        mDoctorPos = mDoctorsCursor.getColumnIndex(DatabaseHelper._ID);
        mDoctotFirabasePos = mDoctorsCursor.getColumnIndex(DatabaseHelper._ID_DOCTOR_FIREBASE);
        mDoctorNamePos = mDoctorsCursor.getColumnIndex(DatabaseHelper.NAME_DOCTOR);
        mDoctorPlacePos = mDoctorsCursor.getColumnIndex(DatabaseHelper.PLACE_DOCTOR);
        mDoctorNumberPos = mDoctorsCursor.getColumnIndex(DatabaseHelper.SPEC_DOCTOR);
        mDoctorImagePos = mDoctorsCursor.getColumnIndex(DatabaseHelper.IMAGE_DOCTOR_URL);
        ...
        public void onClick(View view) {
                ...
                if (firebaseUser== null|| !firebaseUser.getUid().equals(mFireBaseId)) {
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                        ...
                        Pair<View, String> p2 = Pair.create((View)mDoctorNameTextView,"DOCTORNAME");
